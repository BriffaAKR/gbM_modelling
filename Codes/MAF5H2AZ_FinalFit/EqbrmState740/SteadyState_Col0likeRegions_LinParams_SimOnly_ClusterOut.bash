...
python3 -u SteadyState_Col0likeRegions_LinParams_SimOnly_ClusterOut.py ${SLURM_ARRAY_TASK_ID} 1000 # check last integer compatible with array end
##python3 -u SteadyState_Col0likeRegions_LinParams_SimOnly_ClusterOut.py ${SLURM_ARRAY_TASK_ID} 10000 # check last integer compatible with array end