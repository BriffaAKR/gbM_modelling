...
ax.set_title("Mean over all loci: %.2f" % np.mean(LocusProperties_Sim_df['Sim_Mfrac_FirstTimeSteadyState_AccnMu'].values*TimeScaleFactor/n_cc),fontsize=10)

fig.tight_layout()
#fig.subplots_adjust(top=0.5)

fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mean_FirstSteadyStateTime_scatter_F4C.png"), bbox_inches = 'tight')
...
ax.set_title("Mean over all loci: %.1f" % np.mean(LocusProperties_Sim_df['Sim_Mfrac_FirstTimeSteadyState_AccnSigma'].values*TimeScaleFactor/n_cc),fontsize=10)

fig.tight_layout()
#fig.subplots_adjust(top=0.5)

fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Std_FirstSteadyStateTime_scatter_SF8C.png"), bbox_inches = 'tight')
