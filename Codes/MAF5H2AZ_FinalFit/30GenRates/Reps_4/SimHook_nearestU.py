...
file_in_GainRateData = params.file_in_GainRateData_NearestU
file_in_LossRateData = params.file_in_LossRateData_NearestU
...
file_in_SimGains_nn_dist_U = os.path.join('Output_files', filename_start + 'SimGains_nn_dist_U'+filename_ending)
file_in_SimLosses_nn_dist_U = os.path.join('Output_files', filename_start + 'SimLosses_nn_dist_U'+filename_ending)
file_in_SimStayM_nn_dist_U = os.path.join('Output_files', filename_start + 'SimStayM_nn_dist_U'+filename_ending)
file_in_SimStayU_nn_dist_U = os.path.join('Output_files', filename_start + 'SimStayU_nn_dist_U'+filename_ending)



SimGains_nn_dist_U_df = pd.read_csv(file_in_SimGains_nn_dist_U, sep="\t{1}",engine='python')
SimLosses_nn_dist_U_df = pd.read_csv(file_in_SimLosses_nn_dist_U, sep="\t{1}",engine='python')
SimStayM_nn_dist_U_df = pd.read_csv(file_in_SimStayM_nn_dist_U, sep="\t{1}",engine='python')
SimStayU_nn_dist_U_df = pd.read_csv(file_in_SimStayU_nn_dist_U, sep="\t{1}",engine='python')


# sum columns of SimGains/Losses and convert to array
SimGains_nn_dist_U_array = np.array(SimGains_nn_dist_U_df.sum(axis=0).tolist())
SimLosses_nn_dist_U_array = np.array(SimLosses_nn_dist_U_df.sum(axis=0).tolist())
SimStayM_nn_dist_U_array = np.array(SimStayM_nn_dist_U_df.sum(axis=0).tolist())
SimStayU_nn_dist_U_array = np.array(SimStayU_nn_dist_U_df.sum(axis=0).tolist())


# NearestU
MovAv_SimGains_nn_dist_U = calc_moving_average(N_window, SimGains_nn_dist_U_array[2:])
MovAv_SimLosses_nn_dist_U = calc_moving_average(N_window, SimLosses_nn_dist_U_array[2:])
MovAv_SimInitiallyM_nn_dist_U = calc_moving_average(N_window, SimStayM_nn_dist_U_array[2:]+SimLosses_nn_dist_U_array[2:])
MovAv_SimInitiallyU_nn_dist_U = calc_moving_average(N_window, SimStayU_nn_dist_U_array[2:]+SimGains_nn_dist_U_array[2:])

MovAv_SimGainRate_nn_dist_U = MovAv_SimGains_nn_dist_U/MovAv_SimInitiallyU_nn_dist_U
MovAv_SimLossRate_nn_dist_U = MovAv_SimLosses_nn_dist_U/MovAv_SimInitiallyM_nn_dist_U
# rescale to per cell cycle
MovAv_SimGainRate_nn_dist_U = MovAv_SimGainRate_nn_dist_U/(n_cc*N_gen_burn_in)
MovAv_SimLossRate_nn_dist_U = MovAv_SimLossRate_nn_dist_U/(n_cc*N_gen_burn_in)
print(len(MovAv_SimGainRate_nn_dist_U),len(MovAv_SimLossRate_nn_dist_U))
...
#Model
ax0[0].plot(x_vals[2:], y_scale*MovAv_SimGainRate_nn_dist_U,label='Simulated\nSmoothed n = %d bp' % N_window, linewidth=2, color='r')
ax0[1].plot(x_vals[2:], y_scale*MovAv_SimLossRate_nn_dist_U,label='Simulated\nSmoothed n = %d bp' % N_window, linewidth=2, color='b')

from mpl_toolkits.axes_grid1.inset_locator import inset_axes
# gains inset
axins_0 = inset_axes(ax0[0], width="40%", height="50%", borderpad=1, loc=2)
axins_0.tick_params(axis='both', which='major', labelsize=18)
axins_0.yaxis.tick_right()
axins_0.set_xlim(0,60)
...
axins_0.plot(x_vals[2:], y_scale*MovAv_SimGainRate_nn_dist_U, color='r',linestyle='-',linewidth=2,label='Simulated\nSmoothed n = %d bp' % N_window)

# # losses inset
# axins_1 = inset_axes(ax0[1], width="50%", height="50%", borderpad=1, loc=2)
# axins_1.tick_params(axis='both', which='major', labelsize=18)
...
# axins_1.plot(x_vals[2:], y_scale*MovAv_SimLossRate_nn_dist_U,label='Simulated\nSmoothed n = %d bp' % N_window, linewidth=2, color='b')





ax0[0].set_ylim(0,1.5)
ax0[1].set_ylim(0,1.0)

ax0[0].set_xlabel("Distance to nearest $U$-site (bp)", fontsize=18)
ax0[0].set_ylabel("Gain rate per cell cycle"+y_scale_label, fontsize=18)
# ,loc=(0.18,0.40)
# ax0[0].legend(fontsize=18,ncol=4,facecolor='white', framealpha=0.6)
ax0[0].tick_params(axis='both', which='major', labelsize=18)

ax0[1].set_xlabel("Distance to nearest $U$-site (bp)", fontsize=18)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestU_large.png'), bbox_inches = 'tight')
...
# # losses inset
# axins_1 = inset_axes(ax0[1], width="50%", height="50%", borderpad=1, loc=2)
# axins_1.tick_params(axis='both', which='major', labelsize=12)
# axins_1.yaxis.tick_right()
# axins_1.set_xlim(0,100)
# axins_1.set_ylim(0,0.75)
...
ax0[0].set_xlabel("Distance to nearest $U$-site (bp)", fontsize=12)
ax0[0].set_ylabel("Gain rate\n per cell cycle"+y_scale_label, fontsize=12)
# ,loc=(0.18,0.40)
#ax0[0].legend(fontsize=10,ncol=2,facecolor='white', framealpha=0.6)
ax0[0].tick_params(axis='both', which='major', labelsize=12)

ax0[1].set_ylim(0,1)
ax0[1].set_xlabel("Distance to nearest $U$-site (bp)", fontsize=12)
ax0[1].set_ylabel("Loss rate\n per cell cylce"+y_scale_label, fontsize=12)
#ax0[1].legend(fontsize=10,ncol=2,loc=2,facecolor='white', framealpha=0.6)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestU_Pair'+'.png'), bbox_inches = 'tight')
...
#Model
ax0.plot(x_vals[2:], y_scale*MovAv_SimGainRate_nn_dist_U,label='Simulated\nSmoothed n = %d bp' % N_window, linewidth=2, color='r')
...
ax0.set_xlabel("Distance to nearest $U$-site (bp)", fontsize=12)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimGainsTail_NearestU'+'.png'), bbox_inches = 'tight')
...
from mpl_toolkits.axes_grid1.inset_locator import inset_axes
# gains inset
axins_0 = inset_axes(ax0, width="40%", height="50%", borderpad=1, loc=2)
axins_0.tick_params(axis='both', which='major', labelsize=12)
axins_0.yaxis.tick_right()
axins_0.set_xlim(0,60)
axins_0.set_ylim(0,0.4)
...
ax0.set_ylabel("Gain rate\n per cell cycle"+y_scale_label, fontsize=12)
# ,loc=(0.18,0.40)
#ax0.legend(fontsize=10,ncol=2,facecolor='white', framealpha=0.6)
ax0.tick_params(axis='both', which='major', labelsize=12)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestU_Gains_FS9D_top'+'.png'), bbox_inches = 'tight')
...
#Model
ax0.plot(x_vals[2:], y_scale*MovAv_SimLossRate_nn_dist_U,label='Simulated\nSmoothed n = %d bp' % N_window, linewidth=2, color='b')
...
#ax0.legend(fontsize=10,ncol=2,loc=2,facecolor='white', framealpha=0.6)
ax0.tick_params(axis='both', which='major', labelsize=12)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestU_Losses_FS9D_bottom'+'.png'), bbox_inches = 'tight')
