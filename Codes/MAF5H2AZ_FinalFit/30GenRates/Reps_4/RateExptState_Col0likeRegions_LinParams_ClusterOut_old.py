...
#                                             'D3D4D5_mu_meth_diff', 'CG_spacing', 'mean_h2az', 'max_h2az'
#                                            ]
...
def single_gene_sim_eqbrm_single_time_stats(N_CG_, state_, CG_positions_,
    ...
    for i_seg_current_gene in range(0,current_number_of_segments):
        ...
        for i_reps in range(0,N_reps):
            ...
            gains_nn_dist_M_temp, gains_nn_dist_U_temp, losses_nn_dist_M_temp, losses_nn_dist_U_temp, \
                stayU_nn_dist_M_temp, stayU_nn_dist_U_temp, stayM_nn_dist_M_temp, stayM_nn_dist_U_temp = changed_sites_analysis(N_CG, state_gene, eqbrm_state_output_temp, CG_positions_gene)
...
#            # finished write out simulated state to file
        ...
        #                                     D3_mu_meth_diff, D4_mu_meth_diff, D5_mu_meth_diff,
        #                                     D3D4D5_mu_meth_diff, 1./N_CG_density, mean_h2az, max_h2az
        #                                    ]
