...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimGainsTail_NearestM_FS7A_bottom'+'.png'), bbox_inches = 'tight')
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestM_Gains_FS7A_left'+'.png'), bbox_inches = 'tight')
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestM_Losses_FS7A_right'+'.png'), bbox_inches = 'tight')
