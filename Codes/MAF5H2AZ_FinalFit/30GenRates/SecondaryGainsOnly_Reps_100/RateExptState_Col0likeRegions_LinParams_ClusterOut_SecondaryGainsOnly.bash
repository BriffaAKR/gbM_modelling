...
python3 -u RateExptState_Col0likeRegions_LinParams_ClusterOut_SecondaryGainsOnly.py ${SLURM_ARRAY_TASK_ID} 250 # check last integer compatible with array end