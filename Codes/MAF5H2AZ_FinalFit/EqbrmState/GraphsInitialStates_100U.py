...
filename_start = "MAF5_H2AZWT_EqbrmOutput_FinalFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_"
filename_ending = '.tsv'
...
file_in_AllRepsMethFracs_100U_RatesOnlyFit = os.path.join('Output_files', 
'MAF5_H2AZWT_EqbrmOutput_RatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_AllRepsMethFracs.tsv')
AllRepsMethFracs_100U_RatesOnlyFit_df = pd.read_csv(file_in_AllRepsMethFracs_100U_RatesOnlyFit, sep="\t{1}",engine='python')
AllRepsMethFracs_100U_RatesOnlyFit_df.set_index("gene_ID", inplace = True)
print('N_gene_Expt',len(AllRepsMethFracs_100U_RatesOnlyFit_df))
...
hist_Data, bins_Data = np.histogram(AllRepsMethFracs_100U_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
hist_Data = hist_Data/N_reps # normalise
# ax.axvline(np.nanmean(AllRepsMethFracs_100U_df[temp_cols_list].values*values_scaler), linestyle='--', color='g')
ax.plot(x_hist, hist_Data,  linewidth = 2, color=col_data_Col0, linestyle='-',
                  label='%s\nMean = %.1f %%' % (hist_Data_label,np.nanmean(AllRepsMethFracs_100U_df[temp_cols_list].values*values_scaler)) )



##

hist_Sims_100U_label = 'Simulated'
...
ax.plot(x_hist, hist_Sims_100U,  linewidth = 2, color=col_Sim_Expt,linestyle='-',
...
fig.savefig( os.path.join(GraphFolder,filename_start +"Mfrac_InitialState_100U"+".png"), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,filename_start +"Mfrac_InitialState_100U"+".pdf"), bbox_inches = 'tight')
...
fig.savefig( os.path.join(GraphFolder,filename_start +"Mfrac_InitialState_Convgd"+".pdf"), bbox_inches = 'tight')
...
fig.savefig( os.path.join(GraphFolder,filename_start +"Mfrac_InitialState_100U_MeanOverReps"+".png"), bbox_inches = 'tight')
...
for axi in range(N_plots_axi):
    for axj in range(N_plots_axj):
        ...
        Temp_Sim_df1 = AllRepsMethFracs_100U_df.loc[ ((LocusProperties_df['CG_density'] >= (1./CG_density_mins[axj])) &
        ...
        Temp_Sim_df0 = AllRepsMethFracs_100U_RatesOnlyFit_df.loc[ ((LocusProperties_df['CG_density'] >= (1./CG_density_mins[axj])) &
                                                    (LocusProperties_df['CG_density'] < (1./CG_density_maxs[axj]))) ]
...
fig.savefig( os.path.join(GraphFolder,filename_start +'Mfrac_dist_groups_Rho'+str(N_plots_axj)+'Col0_.png'), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,filename_start +'Mfrac_dist_groups_Rho'+str(N_plots_axj)+'Col0_.pdf'), bbox_inches = 'tight')
...
for axi in range(N_plots_axi):
    for axj in range(N_plots_axj):
        ...
        # 30 Col-like accns 
        Temp_Data_df = AllRepsMethFracs_100U_df.loc[ ((LocusProperties_df['CG_density'] >= 1./CG_density_mins[axj]) &
                                                    (LocusProperties_df['CG_density'] < 1./CG_density_maxs[axj])) ]                                           
...
fig.savefig( os.path.join(GraphFolder,filename_start +'Mfrac_dist_groups_Rho'+str(N_plots_axj)+'.png'), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,filename_start +'Mfrac_dist_groups_Rho'+str(N_plots_axj)+'.pdf'), bbox_inches = 'tight')
...
for i_temp in range(N_reps):
    temp_cols_list.append('Sim_meth_frac_'+str(i_temp))
hist_Sims_Expt, bins_Sim = np.histogram(AllRepsMethFracs_100U_RatesOnlyFit_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
hist_Sims_Expt = hist_Sims_Expt/N_reps # normalise
# ax.axvline(np.nanmean(AllRepsMethFracs_100U_RatesOnlyFit_df[temp_cols_list].values*values_scaler), linestyle='-', color=col_Sim_Expt)
ax.plot(x_hist, hist_Sims_Expt,  linewidth = 2, color=col_Sim_Expt,linestyle='-',
                  label='%s\nMean = %.1f %%' % (hist_Sims_Expt_label,np.nanmean(AllRepsMethFracs_100U_RatesOnlyFit_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,"MAF5_H2AZWT_EqbrmOutput_RatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_Mfrac_InitialState_100U_Col0"+".png"), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,"MAF5_H2AZWT_EqbrmOutput_RatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_Mfrac_InitialState_100U_Col0"+".pdf"), bbox_inches = 'tight')
...
fig.savefig( os.path.join(GraphFolder,"MAF5_H2AZWT_EqbrmOutput_RatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_Mfrac_InitialState_100U"+".png"), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,"MAF5_H2AZWT_EqbrmOutput_RatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_Mfrac_InitialState_100U"+".pdf"), bbox_inches = 'tight')
