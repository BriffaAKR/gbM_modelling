...
##SBATCH --array=0-4 # end of array (N).  2nd argument of python code should be: N . start of array must by 0
...
python3 -u SteadyState_Col0likeRegions_LinParams_SimOnly_Flucts_rhoCGcontrol_ClusterOut.py ${SLURM_ARRAY_TASK_ID} 1000 # check last integer compatible with array end
