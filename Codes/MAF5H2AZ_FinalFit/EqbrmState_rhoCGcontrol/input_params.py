...
filename_params_code = 'Pchoice_'+P_choice+'_'+'InitialState_'+initial_state_choice+'_'
...
filename_start_Sim = "MAF5_H2AZWT_EqbrmOutput_FinalFit_Flucts_rhoCGcontrol_" + accessions_label + filename_params_code_Sim 
# filename_start_Dat = "MAF5_H2AZWT_EqbrmOutput_FinalFit_Flucts_" + accessions_label + filename_params_code_Dat 
filename_start_Graph = "MAF5_H2AZWT_EqbrmOutput_FinalFit_Flucts_rhoCGcontrol_" + accessions_label + filename_params_code_Graph 
