...
file_in_annotation = "Col0_GBM_Segments.tsv"
N_total_IDs = 17800 # This must be more than the total number of IDs in the annotation!!!
...
filename_start = "GBMSegments_EqbrmOutput_WgRatesOnlyFit_"+filename_params_code
