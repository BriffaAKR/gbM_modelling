...
# set seed to zero at start of code (in case using for intial state too)
np.random.seed(0)
...
#for i_gene in range(2000):
    ...
    current_number_of_segments = len(current_segments_df) 
    ...
    for i_seg_current_gene in range(0,current_number_of_segments):
        ...
        segment_no_index = current_segments_df.columns.get_loc('segment_no')
        mean_h2az_index = current_segments_df.columns.get_loc('mean_h2az')
        max_h2az_index = current_segments_df.columns.get_loc('max_h2az')
        current_segment_no = current_segments_df.iloc[i_seg_current_gene,segment_no_index]
        mean_h2az = current_segments_df.iloc[i_seg_current_gene,mean_h2az_index]
        max_h2az = current_segments_df.iloc[i_seg_current_gene,max_h2az_index]
