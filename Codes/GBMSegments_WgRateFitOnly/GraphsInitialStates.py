...
filename_start_Graph = 'GBMSegments_EqbrmOutput_WgRatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_Graph_'

# LocusProperties used for Col0 data - only need to load in once! 
file_in_LocusProperties = os.path.join('Output_files', 'GBMSegments_EqbrmOutput_WgRatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_LocusProperties.tsv')
