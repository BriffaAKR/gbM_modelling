...
ax0[0].legend(fontsize=12,ncol=1,facecolor='white', framealpha=1,handlelength=0.6)
...
ax0[1].legend(fontsize=12,ncol=1,facecolor='white', framealpha=1,handlelength=0.6)
...
ax0[0].plot(x_vals_interaction,np.array(gain_interaction_curve_secondary)/y_scale,label='Secondardy cooperative gain',color='k',linestyle='--',linewidth=2)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'DataRates_NearestM_Interaction_large.png'), bbox_inches = 'tight')
...
# ax0.set_xlabel("Distance to nearest M site (bps)", fontsize=18)
# ax0.set_ylabel("Gain rate\n per cell cycle"+y_scale_label, fontsize=18)
# # ,loc=(0.18,0.40)
# #ax0.legend(fontsize=16,ncol=2,facecolor='white', framealpha=0.6)
