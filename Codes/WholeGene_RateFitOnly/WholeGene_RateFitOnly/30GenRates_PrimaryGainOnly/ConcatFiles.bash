...
filename_start="WholeGBMgenes_RatesOutput_RatesOnlyFit_PrimaryGainOnly_Pchoice_Excl_InitialState_Expt_Nreps_4_"
# use to shorten filename
#Output_filename_start="MAF5_H2AZWT_Col0_RatesOutput_Pchoice_Excl_RatesOnlyFit_"
Output_filename_start=$filename_start
...
output_filename_1="$output_folder$Output_filename_start$output_filename_end_1"

#output_filename_2a="$output_folder$Output_filename_start$output_filename_end_2a"
#output_filename_2b="$output_folder$Output_filename_start$output_filename_end_2b"
#output_filename_2c="$output_folder$Output_filename_start$output_filename_end_2c"
#output_filename_2d="$output_folder$Output_filename_start$output_filename_end_2d"
#output_filename_2e="$output_folder$Output_filename_start$output_filename_end_2e"
#output_filename_2f="$output_folder$Output_filename_start$output_filename_end_2f"
#output_filename_2g="$output_folder$Output_filename_start$output_filename_end_2g"
#output_filename_2h="$output_folder$Output_filename_start$output_filename_end_2h"

#output_filename_3a="$output_folder$Output_filename_start$output_filename_end_3a"
#output_filename_3b="$output_folder$Output_filename_start$output_filename_end_3b"
#output_filename_3c="$output_folder$Output_filename_start$output_filename_end_3c"
#output_filename_3d="$output_folder$Output_filename_start$output_filename_end_3d"
#output_filename_3e="$output_folder$Output_filename_start$output_filename_end_3e"
#output_filename_3f="$output_folder$Output_filename_start$output_filename_end_3f"
#output_filename_3g="$output_folder$Output_filename_start$output_filename_end_3g"
#output_filename_3h="$output_folder$Output_filename_start$output_filename_end_3h"

#output_filename_4a="$output_folder$Output_filename_start$output_filename_end_4a"
#output_filename_4b="$output_folder$Output_filename_start$output_filename_end_4b"
#output_filename_4c="$output_folder$Output_filename_start$output_filename_end_4c"
#output_filename_4d="$output_folder$Output_filename_start$output_filename_end_4d"
#output_filename_4e="$output_folder$Output_filename_start$output_filename_end_4e"
#output_filename_4f="$output_folder$Output_filename_start$output_filename_end_4f"
#output_filename_4g="$output_folder$Output_filename_start$output_filename_end_4g"
#output_filename_4h="$output_folder$Output_filename_start$output_filename_end_4h"

#output_filename_5a="$output_folder$Output_filename_start$output_filename_end_5a"
#output_filename_5b="$output_folder$Output_filename_start$output_filename_end_5b"
#output_filename_5c="$output_folder$Output_filename_start$output_filename_end_5c"
#output_filename_5d="$output_folder$Output_filename_start$output_filename_end_5d"
#output_filename_5e="$output_folder$Output_filename_start$output_filename_end_5e"
#output_filename_5f="$output_folder$Output_filename_start$output_filename_end_5f"
#output_filename_5g="$output_folder$Output_filename_start$output_filename_end_5g"
#output_filename_5h="$output_folder$Output_filename_start$output_filename_end_5h"

#output_filename_6a="$output_folder$Output_filename_start$output_filename_end_6a"
#output_filename_6b="$output_folder$Output_filename_start$output_filename_end_6b"
#output_filename_6c="$output_folder$Output_filename_start$output_filename_end_6c"
#output_filename_6d="$output_folder$Output_filename_start$output_filename_end_6d"
#output_filename_6e="$output_folder$Output_filename_start$output_filename_end_6e"
#output_filename_6f="$output_folder$Output_filename_start$output_filename_end_6f"
#output_filename_6g="$output_folder$Output_filename_start$output_filename_end_6g"
#output_filename_6h="$output_folder$Output_filename_start$output_filename_end_6h"

output_filename_7="$output_folder$Output_filename_start$output_filename_end_7"
output_filename_8="$output_folder$Output_filename_start$output_filename_end_8"
output_filename_10="$output_folder$Output_filename_start$output_filename_end_10"
#output_filename_11="$output_folder$Output_filename_start$output_filename_end_11"

output_filename_12a="$output_folder$Output_filename_start$output_filename_end_12a"
output_filename_12b="$output_folder$Output_filename_start$output_filename_end_12b"
output_filename_12c="$output_folder$Output_filename_start$output_filename_end_12c"
output_filename_12d="$output_folder$Output_filename_start$output_filename_end_12d"
output_filename_12e="$output_folder$Output_filename_start$output_filename_end_12e"
output_filename_12f="$output_folder$Output_filename_start$output_filename_end_12f"
output_filename_12g="$output_folder$Output_filename_start$output_filename_end_12g"
output_filename_12h="$output_folder$Output_filename_start$output_filename_end_12h"
