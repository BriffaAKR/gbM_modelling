...
N_reps = 4 # Number of simulation reps
...
filename_params_code = 'Pchoice_'+P_choice+'_'+'InitialState_'+initial_state_choice+'_'+'Nreps_'+str(N_reps)+'_'
...
filename_start = "WholeGBMgenes_RatesOutput_RatesOnlyFit_NoCoopMaint_"+filename_params_code
...
g_m_val = 0.0 # -15.0
g_c_val = 0.0 # 0.5 # 0.90 # 0.59 - (g_m_val/53.)
