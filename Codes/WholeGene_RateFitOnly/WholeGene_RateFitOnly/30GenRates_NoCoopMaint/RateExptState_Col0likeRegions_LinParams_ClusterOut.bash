...
#SBATCH -p rg-mh
##SBATCH -p jic-medium
##SBATCH -t 1-00:00                     # timelimit (D-HH:MM)
...
python3 -u RateExptState_Col0likeRegions_LinParams_ClusterOut.py ${SLURM_ARRAY_TASK_ID} 250 # check last integer compatible with array end