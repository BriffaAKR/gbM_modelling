...
#     line_writer.writerow( ['Index', 'Total_Gains_per_cc','Total_Losses_per_cc','Total_GainRate_per_cc','Total_LossRate_per_cc','Gain_Loss_Ratio_per_cc'
#     ,'Total_M_0','GainRate_Div_GainRatePlusLossRate'] )
#     line_writer.writerow( [sim_type,Total_Gains_per_cc,Total_Losses_per_cc,Total_GainRate_per_cc,Total_LossRate_per_cc,Total_GainRate_per_cc/Total_LossRate_per_cc
#     ,Total_M_0,Total_GainRate_per_cc/(Total_GainRate_per_cc+Total_LossRate_per_cc)] )
...
ax0[0].set_xlabel("Distance to nearest $M$-site (bp)", fontsize=12)
...
ax0[1].set_ylim(0,3)
ax0[1].set_xlabel("Distance to nearest $M$-site (bp)", fontsize=12)
...
ax0.set_xlabel("Distance to nearest $M$-site (bp)", fontsize=12)
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimGainsTail_NearestM_FS5G'+'.png'), bbox_inches = 'tight')
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestM_Gains_F3E'+'.png'), bbox_inches = 'tight')
...
fig0.savefig( os.path.join(GraphFolder,filename_start +'SimRates_NearestM_Losses_F3F'+'.png'), bbox_inches = 'tight')
