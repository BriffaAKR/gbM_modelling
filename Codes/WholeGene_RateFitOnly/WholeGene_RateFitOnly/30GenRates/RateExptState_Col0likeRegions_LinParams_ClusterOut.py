...
Parental_Col0_state_file = os.path.join( path_string, file_in_Parental_Col0_state )
...
#file_name_output_PairSeparationsMM_D3 = os.path.join('Output_batch_files/Correlations_D3/PairSeparationsMM_D3', filename_start + 'PairSeparationsMM_D3_'+filename_ending)
#file_name_output_PairSeparationsMU_D3 = os.path.join('Output_batch_files/Correlations_D3/PairSeparationsMU_D3', filename_start + 'PairSeparationsMU_D3_'+filename_ending)
#file_name_output_PairSeparationsUU_D3 = os.path.join('Output_batch_files/Correlations_D3/PairSeparationsUU_D3', filename_start + 'PairSeparationsUU_D3_'+filename_ending)
#file_name_output_PairSeparationsXX_D3 = os.path.join('Output_batch_files/Correlations_D3/PairSeparationsXX_D3', filename_start + 'PairSeparationsXX_D3_'+filename_ending)
#file_name_output_PairSeparationsMM_D4 = os.path.join('Output_batch_files/Correlations_D4/PairSeparationsMM_D4', filename_start + 'PairSeparationsMM_D4_'+filename_ending)
#file_name_output_PairSeparationsMU_D4 = os.path.join('Output_batch_files/Correlations_D4/PairSeparationsMU_D4', filename_start + 'PairSeparationsMU_D4_'+filename_ending)
#file_name_output_PairSeparationsUU_D4 = os.path.join('Output_batch_files/Correlations_D4/PairSeparationsUU_D4', filename_start + 'PairSeparationsUU_D4_'+filename_ending)
#file_name_output_PairSeparationsXX_D4 = os.path.join('Output_batch_files/Correlations_D4/PairSeparationsXX_D4', filename_start + 'PairSeparationsXX_D4_'+filename_ending)
...
#file_name_output_NearestPairSeparationsMM_D3 = os.path.join('Output_batch_files/Correlations_D3/NearestPairSeparationsMM_D3', filename_start + 'NearestPairSeparationsMM_D3_'+filename_ending)
#file_name_output_NearestPairSeparationsMU_D3 = os.path.join('Output_batch_files/Correlations_D3/NearestPairSeparationsMU_D3', filename_start + 'NearestPairSeparationsMU_D3_'+filename_ending)
#file_name_output_NearestPairSeparationsUU_D3 = os.path.join('Output_batch_files/Correlations_D3/NearestPairSeparationsUU_D3', filename_start + 'NearestPairSeparationsUU_D3_'+filename_ending)
#file_name_output_NearestPairSeparationsXX_D3 = os.path.join('Output_batch_files/Correlations_D3/NearestPairSeparationsXX_D3', filename_start + 'NearestPairSeparationsXX_D3_'+filename_ending)
#file_name_output_NearestPairSeparationsMM_D4 = os.path.join('Output_batch_files/Correlations_D4/NearestPairSeparationsMM_D4', filename_start + 'NearestPairSeparationsMM_D4_'+filename_ending)
#file_name_output_NearestPairSeparationsMU_D4 = os.path.join('Output_batch_files/Correlations_D4/NearestPairSeparationsMU_D4', filename_start + 'NearestPairSeparationsMU_D4_'+filename_ending)
#file_name_output_NearestPairSeparationsUU_D4 = os.path.join('Output_batch_files/Correlations_D4/NearestPairSeparationsUU_D4', filename_start + 'NearestPairSeparationsUU_D4_'+filename_ending)
#file_name_output_NearestPairSeparationsXX_D4 = os.path.join('Output_batch_files/Correlations_D4/NearestPairSeparationsXX_D4', filename_start + 'NearestPairSeparationsXX_D4_'+filename_ending)
...
file_name_output_SimGains_nn_dist_M = os.path.join('Output_batch_files/ChangedSites/gains_nn_dist_M', filename_start + 'SimGains_nn_dist_M_'+filename_ending)
file_name_output_SimGains_nn_dist_U = os.path.join('Output_batch_files/ChangedSites/gains_nn_dist_U', filename_start + 'SimGains_nn_dist_U_'+filename_ending)
file_name_output_SimLosses_nn_dist_M = os.path.join('Output_batch_files/ChangedSites/losses_nn_dist_M', filename_start + 'SimLosses_nn_dist_M_'+filename_ending)
file_name_output_SimLosses_nn_dist_U = os.path.join('Output_batch_files/ChangedSites/losses_nn_dist_U', filename_start + 'SimLosses_nn_dist_U_'+filename_ending)
file_name_output_SimStayM_nn_dist_M = os.path.join('Output_batch_files/ChangedSites/stayM_nn_dist_M', filename_start + 'SimStayM_nn_dist_M_'+filename_ending)
file_name_output_SimStayM_nn_dist_U = os.path.join('Output_batch_files/ChangedSites/stayM_nn_dist_U', filename_start + 'SimStayM_nn_dist_U_'+filename_ending)
file_name_output_SimStayU_nn_dist_M = os.path.join('Output_batch_files/ChangedSites/stayU_nn_dist_M', filename_start + 'SimStayU_nn_dist_M_'+filename_ending)
file_name_output_SimStayU_nn_dist_U = os.path.join('Output_batch_files/ChangedSites/stayU_nn_dist_U', filename_start + 'SimStayU_nn_dist_U_'+filename_ending)



# # define column headings for LocusProperties file
LocusProperties_headings = ['gene_ID', 'segment_number','seed', 'N_CG', 'L_locus', 'CG_density',
#                                            'Sim_mu_meth_frac', 'Sim_sigma_meth_frac', 
#                                            'Sim10_mu_meth_frac', 'Sim10_sigma_meth_frac',
#                                            'D3_mu_meth_frac', 'D3_sigma_meth_frac', 
#                                            'D4_mu_meth_frac', 'D4_sigma_meth_frac', 
#                                             'D5_mu_meth_frac', 'D5_sigma_meth_frac',
#                                            'D3D4D5_mu_meth_frac', 'D3D4D5_sigma_meth_frac',
#                                             'Sim_number_0M_frac', 'Sim10_number_0M_frac',
#                                             'D3_number_0M_frac', 'D4_number_0M_frac', 
#                                             'D5_number_0M_frac',
#                                             'D3D4D5_number_0M_frac',
                                            'Col0_meth_frac', 
#                                             'Sim_meth_frac_0', 'Sim_meth_frac_1', 'Sim_meth_frac_2',
#                                             'D3_meth_frac_0', 'D3_meth_frac_1', 'D3_meth_frac_2', 
#                                             'D4_meth_frac_0', 'D4_meth_frac_1', 'D4_meth_frac_2', 
#                                             'D5_meth_frac_0', 'D5_meth_frac_1', 'D5_meth_frac_2',
#                                             'D3_mu_meth_diff', 'D4_mu_meth_diff', 'D5_mu_meth_diff',
#                                             'D3D4D5_mu_meth_diff', 
                                            'CG_spacing', 'mean_h2az', 'max_h2az',
                                            'locus_gain_rate_mu', 'locus_gain_rate_sigma',
                                            'locus_loss_rate_mu','locus_loss_rate_sigma'
                                           ]
...
#                             'D3_meth_frac_0','D3_meth_frac_1','D3_meth_frac_2','D3_meth_frac_3','D3_meth_frac_4',
#                             'D3_meth_frac_5','D3_meth_frac_6','D3_meth_frac_7','D3_meth_frac_8','D3_meth_frac_9',
#                             'D4_meth_frac_0', 'D4_meth_frac_1', 'D4_meth_frac_2', 'D4_meth_frac_3', 'D4_meth_frac_4', 
#                             'D4_meth_frac_5', 'D4_meth_frac_6', 'D4_meth_frac_7', 'D4_meth_frac_8', 'D4_meth_frac_9', 
#                             'D5_meth_frac_0', 'D5_meth_frac_1', 'D5_meth_frac_2', 'D5_meth_frac_3', 'D5_meth_frac_4', 
#                             'D5_meth_frac_5', 'D5_meth_frac_6', 'D5_meth_frac_7', 'D5_meth_frac_8', 'D5_meth_frac_9']
...
if i_batch == 0:
    ...
    open(file_name_output_SimGains_nn_dist_M,'w').close
    open(file_name_output_SimGains_nn_dist_U,'w').close
    open(file_name_output_SimLosses_nn_dist_M,'w').close
    open(file_name_output_SimLosses_nn_dist_U,'w').close
    open(file_name_output_SimStayM_nn_dist_M,'w').close
    open(file_name_output_SimStayM_nn_dist_U,'w').close
    open(file_name_output_SimStayU_nn_dist_M,'w').close
    open(file_name_output_SimStayU_nn_dist_U,'w').close
    ...
    #open(file_name_output_PairSeparationsMM_D3,'w').close
    #open(file_name_output_PairSeparationsMU_D3,'w').close
    #open(file_name_output_PairSeparationsUU_D3,'w').close
    #open(file_name_output_PairSeparationsXX_D3,'w').close
    ...
    #open(file_name_output_NearestPairSeparationsMM_D3,'w').close
    #open(file_name_output_NearestPairSeparationsMU_D3,'w').close
    #open(file_name_output_NearestPairSeparationsUU_D3,'w').close
    #open(file_name_output_NearestPairSeparationsXX_D3,'w').close
...
# create lazy reader object
temp_input_df = dd.read_csv(Parental_Col0_state_file,sep='\t',
...
def create_initial_state_eqbrm_Col0like_regions(ID_, initial_state_choice_, P_choice_,
    ...
    if initial_state_choice_ == '100% U':
        state_sim_input_ = np.full(N_CG_,0)
    elif initial_state_choice_ == '100% M':
...
# function to compare initial and final state, and using 
# look up table of CG_positions calculate distatnces to nearest U or M etc.

def changed_sites_analysis(N_, state_initial_, state_final_, CG_positions_):
    
    initial_threshold_value = 1e50
    ...
    for i_ in range(0,N_):
        # U -> M
        if state_initial_[i_] == 0 and state_final_[i_] == 2:
            nearest_U_dist = initial_threshold_value
            nearest_M_dist = initial_threshold_value
            for i_1 in range(0,i_):
                temp_dist = abs(CG_positions_[i_] - CG_positions_[i_1])
                if state_initial_[i_1] == 0:
                    if temp_dist < nearest_U_dist:
                        nearest_U_dist = temp_dist
                if state_initial_[i_1] == 2:
                    if temp_dist < nearest_M_dist:
                        nearest_M_dist = temp_dist
            for i_1 in range(i_+1,N_):
                temp_dist = abs(CG_positions_[i_] - CG_positions_[i_1])
                if state_initial_[i_1] == 0:
                    if temp_dist < nearest_U_dist:
                        nearest_U_dist = temp_dist
                if state_initial_[i_1] == 2:
                    if temp_dist < nearest_M_dist:
                        nearest_M_dist = temp_dist
            if nearest_M_dist < initial_threshold_value:
                gains_nn_dist_M_.append(nearest_M_dist)
            if nearest_U_dist < initial_threshold_value:
                gains_nn_dist_U_.append(nearest_U_dist)
        # M -> U
        if state_initial_[i_] == 2 and state_final_[i_] == 0:
            nearest_U_dist = initial_threshold_value
            nearest_M_dist = initial_threshold_value
            for i_1 in range(0,i_):
                temp_dist = abs(CG_positions_[i_] - CG_positions_[i_1])
            ...
            for i_1 in range(i_+1,N_):
                ...
                if state_initial_[i_1] == 2:
                    if temp_dist < nearest_M_dist:
                        nearest_M_dist = temp_dist
            if nearest_M_dist < initial_threshold_value:
                losses_nn_dist_M_.append(nearest_M_dist)
            if nearest_U_dist < initial_threshold_value:
                losses_nn_dist_U_.append(nearest_U_dist)
        # U -> U
        if state_initial_[i_] == 0 and state_final_[i_] == 0:
            nearest_U_dist = initial_threshold_value
            nearest_M_dist = initial_threshold_value
            for i_1 in range(0,i_):
                temp_dist = abs(CG_positions_[i_] - CG_positions_[i_1])
            ...
            for i_1 in range(i_+1,N_):
                ...
                if state_initial_[i_1] == 2:
                    if temp_dist < nearest_M_dist:
                        nearest_M_dist = temp_dist
            if nearest_M_dist < initial_threshold_value:
                stayU_nn_dist_M_.append(nearest_M_dist)
            if nearest_U_dist < initial_threshold_value:
                stayU_nn_dist_U_.append(nearest_U_dist)
        # M -> M
        if state_initial_[i_] == 2 and state_final_[i_] == 2:
            nearest_U_dist = initial_threshold_value
            nearest_M_dist = initial_threshold_value
            for i_1 in range(0,i_):
                temp_dist = abs(CG_positions_[i_] - CG_positions_[i_1])
            ...
            for i_1 in range(i_+1,N_):
                ...
                if state_initial_[i_1] == 2:
                    if temp_dist < nearest_M_dist:
                        nearest_M_dist = temp_dist
            if nearest_M_dist< initial_threshold_value:
                stayM_nn_dist_M_.append(nearest_M_dist)
            if nearest_U_dist < initial_threshold_value:
                stayM_nn_dist_U_.append(nearest_U_dist)
            
    return     gains_nn_dist_M_, gains_nn_dist_U_, losses_nn_dist_M_, losses_nn_dist_U_, \
                stayU_nn_dist_M_, stayU_nn_dist_U_, stayM_nn_dist_M_, stayM_nn_dist_U_


# function to update running-mean and variance

def mean_run(n_in_,x_in_,mu_in_,S_in_):
# inputs: n_in :: total number of data points (including new one)
#         x_in :: new data point to be added ie x_n
#         mu_in :: mean for (n-1) data points ie \mu_{(n-1)}
#         S_in :: corrected sum of squares for (n-1) data points ie S_{(n-1)}
# outputs: n_out :: total number of data points (including new one)
#          mu_out :: mean for n data points ie \mu_n
#          S_out :: corrected sum of squards for n data points ie S_n
#          sigma_sq_out :: population variance for n data points ie \sigma^2_n

    mu_out_ = mu_in_ + (x_in_ - mu_in_)/n_in_
    
    S_out_ = S_in_ + (n_in_ - 1.)*(x_in_ - mu_in_)**2./n_in_
    
    sigma_sq_out_ = S_out_/(n_in_-1.)
    
    return mu_out_, S_out_, sigma_sq_out_

# initialise using:
# n_data = 1 # counts number of data points
# mu = x_1 # (or x_0 for a python array)
# S = 0.
# sigma_sq = 0.
...
Sim_gains_nn_dist_M_counts = np.zeros(N_corrns_bins)
Sim_gains_nn_dist_U_counts = np.zeros(N_corrns_bins)
Sim_losses_nn_dist_M_counts = np.zeros(N_corrns_bins)
Sim_losses_nn_dist_U_counts = np.zeros(N_corrns_bins)
Sim_StayM_nn_dist_M_counts = np.zeros(N_corrns_bins)
Sim_StayM_nn_dist_U_counts = np.zeros(N_corrns_bins)
Sim_StayU_nn_dist_M_counts = np.zeros(N_corrns_bins)
Sim_StayU_nn_dist_U_counts = np.zeros(N_corrns_bins)
...
#
#D3_UU_gaps_counts = np.zeros(N_corrns_bins)
#D3_MU_gaps_counts = np.zeros(N_corrns_bins)
#D3_MM_gaps_counts = np.zeros(N_corrns_bins)
#D3_XX_gaps_counts = np.zeros(N_corrns_bins)
#
#D3_UU_nearest_gaps_counts = np.zeros(N_corrns_bins)
#D3_MU_nearest_gaps_counts = np.zeros(N_corrns_bins)
#D3_MM_nearest_gaps_counts = np.zeros(N_corrns_bins)
#D3_XX_nearest_gaps_counts = np.zeros(N_corrns_bins)
#
...
#for i_gene in range(2000):
    ...
    for i_seg_current_gene in range(0,current_number_of_segments):
        ...
        N_CG, CG_positions_gene, state_expt, state_sim_input = create_initial_state_eqbrm_Col0like_regions(current_gene_ID, 
        ...
        # #D3_XX_gaps_pending = []
        # #
        # #D3_UU_nearest_gaps_pending = []
        # #D3_MU_nearest_gaps_pending = []
        # #D3_MM_nearest_gaps_pending = []
        # #D3_XX_nearest_gaps_pending = []
        ...
        #     N_CG_temp, CG_positions_gene_temp, state_expt_temp, state_sim_input_temp = \
        ...
        #     #D3_UU_gaps_pending.extend(expt_UU_gaps_temp)
        #     #D3_MU_gaps_pending.extend(expt_MU_gaps_temp)
        #     #D3_MM_gaps_pending.extend(expt_MM_gaps_temp)
        #     #D3_XX_gaps_pending.extend(expt_XX_gaps_temp)

        #     #D3_UU_nearest_gaps_pending.extend(expt_UU_gaps_nearest_temp)
        #     #D3_MU_nearest_gaps_pending.extend(expt_MU_gaps_nearest_temp)
        #     #D3_MM_nearest_gaps_pending.extend(expt_MM_gaps_nearest_temp)
        #     #D3_XX_nearest_gaps_pending.extend(expt_XX_gaps_nearest_temp)
        ...
        Sim_gains_nn_dist_M_pending = []
        Sim_gains_nn_dist_U_pending = []
        Sim_losses_nn_dist_M_pending = []
        Sim_losses_nn_dist_U_pending = []
        Sim_StayM_nn_dist_M_pending = []
        Sim_StayM_nn_dist_U_pending = []
        Sim_StayU_nn_dist_M_pending = []
        Sim_StayU_nn_dist_U_pending = []
        ...
        for i_reps in range(0,N_reps):
            ...
            # run simulation          
            state_in_temp = state_sim_input.copy()
            sim_outputs_temp = single_gene_sim_eqbrm_single_time_stats(N_CG, 
                                    state_in_temp, CG_positions_gene, spont_gain_params, coop_gain_params, coop_maint_params)
            ...
            eqbrm_state_output_temp = sim_outputs_temp[2] # badly named... only eqbrm_state if sim converged! 
            ...
            gains_nn_dist_M_temp, gains_nn_dist_U_temp, losses_nn_dist_M_temp, losses_nn_dist_U_temp, \
                stayU_nn_dist_M_temp, stayU_nn_dist_U_temp, stayM_nn_dist_M_temp, stayM_nn_dist_U_temp = changed_sites_analysis(N_CG, state_sim_input, eqbrm_state_output_temp, CG_positions_gene)

            Sim_gains_nn_dist_M_pending.extend(gains_nn_dist_M_temp)
            Sim_gains_nn_dist_U_pending.extend(gains_nn_dist_U_temp)
            Sim_losses_nn_dist_M_pending.extend(losses_nn_dist_M_temp)
            Sim_losses_nn_dist_U_pending.extend(losses_nn_dist_U_temp)
            Sim_StayM_nn_dist_M_pending.extend(stayM_nn_dist_M_temp)
            Sim_StayM_nn_dist_U_pending.extend(stayM_nn_dist_U_temp)
            Sim_StayU_nn_dist_M_pending.extend(stayU_nn_dist_M_temp)
            Sim_StayU_nn_dist_U_pending.extend(stayU_nn_dist_U_temp)

            # update running mean and standard deviation for locus rates
            #locus_gain_rate_mu_pending
            #locus_gain_rate_S_pending
            #locus_gain_rate_sigmaSQ_pending
            #locus_loss_rate_mu_pending
            #locus_loss_rate_S_pending
            #locus_loss_rate_sigmaSQ_pending

            # calculate locus gain and loss rates
            Sim_locus_gain_rate_nn_dist_M = (np.float64(len(Sim_gains_nn_dist_M_pending))/
            (np.float64(len(Sim_gains_nn_dist_M_pending))+np.float64(len(Sim_StayU_nn_dist_M_pending)) ))/(n_cc*N_gen_burn_in)
            Sim_locus_gain_rate_nn_dist_U = (np.float64(len(Sim_gains_nn_dist_U_pending))/
            (np.float64(len(Sim_gains_nn_dist_U_pending))+np.float64(len(Sim_StayU_nn_dist_U_pending)) ))/(n_cc*N_gen_burn_in)

            Sim_locus_loss_rate_nn_dist_M = (np.float64(len(Sim_losses_nn_dist_M_pending))/
            (np.float64(len(Sim_losses_nn_dist_M_pending))+np.float64(len(Sim_StayM_nn_dist_M_pending)) ))/(n_cc*N_gen_burn_in)
            Sim_locus_loss_rate_nn_dist_U = (np.float64(len(Sim_losses_nn_dist_U_pending))/
            (np.float64(len(Sim_losses_nn_dist_U_pending))+np.float64(len(Sim_StayM_nn_dist_U_pending)) ))/(n_cc*N_gen_burn_in)

            Sim_locus_gain_rate_temp = np.array([Sim_locus_gain_rate_nn_dist_M,Sim_locus_gain_rate_nn_dist_U])
            Sim_locus_loss_rate_temp = np.array([Sim_locus_loss_rate_nn_dist_M,Sim_locus_loss_rate_nn_dist_U])

            Sim_locus_gain_rate_temp1 = Sim_locus_gain_rate_temp[np.logical_not(np.isnan(Sim_locus_gain_rate_temp))]
            Sim_locus_loss_rate_temp1 = Sim_locus_loss_rate_temp[np.logical_not(np.isnan(Sim_locus_loss_rate_temp))]

            if len(Sim_locus_gain_rate_temp1) > 0:
                Sim_locus_gain_rate = np.float64(Sim_locus_gain_rate_temp1[0])
            else:
                Sim_locus_gain_rate = np.nan
            if len(Sim_locus_loss_rate_temp1) > 0:
                Sim_locus_loss_rate = np.float64(Sim_locus_loss_rate_temp1[0])
            else:
                Sim_locus_loss_rate = np.nan

            # use running mean and standard deviation for locus rates
            # if i_reps == 0 use different initial condition
            if i_reps == 0:
                locus_gain_rate_mu_pending = Sim_locus_gain_rate
                locus_loss_rate_mu_pending = Sim_locus_loss_rate

                locus_gain_rate_S_pending = 0.
                locus_gain_rate_sigmaSQ_pending = 0.

                locus_loss_rate_S_pending = 0.
                locus_loss_rate_sigmaSQ_pending = 0.
            else:
                # apply mean_run function
                locus_gain_rate_mu_pending, locus_gain_rate_S_pending, locus_gain_rate_sigmaSQ_pending = \
                mean_run(i_reps+1,Sim_locus_gain_rate,locus_gain_rate_mu_pending,locus_gain_rate_S_pending)
                locus_loss_rate_mu_pending, locus_loss_rate_S_pending, locus_loss_rate_sigmaSQ_pending = \
                mean_run(i_reps+1,Sim_locus_loss_rate,locus_loss_rate_mu_pending,locus_loss_rate_S_pending)
...
#            # finished write out simulated state to file
        ...
        # calculate histogram counts for changed_sites using base pair bins
        Sim_gains_nn_dist_M_counts_pending, bins_dummy = np.histogram(Sim_gains_nn_dist_M_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_gains_nn_dist_U_counts_pending, bins_dummy = np.histogram(Sim_gains_nn_dist_U_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_losses_nn_dist_M_counts_pending, bins_dummy = np.histogram(Sim_losses_nn_dist_M_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_losses_nn_dist_U_counts_pending, bins_dummy = np.histogram(Sim_losses_nn_dist_U_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_StayM_nn_dist_M_counts_pending, bins_dummy = np.histogram(Sim_StayM_nn_dist_M_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_StayM_nn_dist_U_counts_pending, bins_dummy = np.histogram(Sim_StayM_nn_dist_U_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_StayU_nn_dist_M_counts_pending, bins_dummy = np.histogram(Sim_StayU_nn_dist_M_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        Sim_StayU_nn_dist_U_counts_pending, bins_dummy = np.histogram(Sim_StayU_nn_dist_U_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))

        # And pending count values to totals
        Sim_gains_nn_dist_M_counts = np.add(Sim_gains_nn_dist_M_counts,Sim_gains_nn_dist_M_counts_pending)
        Sim_gains_nn_dist_U_counts = np.add(Sim_gains_nn_dist_U_counts,Sim_gains_nn_dist_U_counts_pending)
        Sim_losses_nn_dist_M_counts = np.add(Sim_losses_nn_dist_M_counts,Sim_losses_nn_dist_M_counts_pending)
        Sim_losses_nn_dist_U_counts = np.add(Sim_losses_nn_dist_U_counts,Sim_losses_nn_dist_U_counts_pending)
        Sim_StayM_nn_dist_M_counts = np.add(Sim_StayM_nn_dist_M_counts,Sim_StayM_nn_dist_M_counts_pending)
        Sim_StayM_nn_dist_U_counts = np.add(Sim_StayM_nn_dist_U_counts,Sim_StayM_nn_dist_U_counts_pending)
        Sim_StayU_nn_dist_M_counts = np.add(Sim_StayU_nn_dist_M_counts,Sim_StayU_nn_dist_M_counts_pending)
        Sim_StayU_nn_dist_U_counts = np.add(Sim_StayU_nn_dist_U_counts,Sim_StayU_nn_dist_U_counts_pending)
        ...
        #Col0_UU_nearest_gaps_counts_pending, bins_dummy = np.histogram(Col0_UU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #Col0_MU_nearest_gaps_counts_pending, bins_dummy = np.histogram(Col0_MU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #Col0_MM_nearest_gaps_counts_pending, bins_dummy = np.histogram(Col0_MM_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #Col0_XX_nearest_gaps_counts_pending, bins_dummy = np.histogram(Col0_XX_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))

        #D3_UU_gaps_counts_pending, bins_dummy = np.histogram(D3_UU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D3_MU_gaps_counts_pending, bins_dummy = np.histogram(D3_MU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D3_MM_gaps_counts_pending, bins_dummy = np.histogram(D3_MM_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D3_XX_gaps_counts_pending, bins_dummy = np.histogram(D3_XX_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))

        #D3_UU_nearest_gaps_counts_pending, bins_dummy = np.histogram(D3_UU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D3_MU_nearest_gaps_counts_pending, bins_dummy = np.histogram(D3_MU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D3_MM_nearest_gaps_counts_pending, bins_dummy = np.histogram(D3_MM_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D3_XX_nearest_gaps_counts_pending, bins_dummy = np.histogram(D3_XX_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        ...
        #D4_UU_nearest_gaps_counts_pending, bins_dummy = np.histogram(D4_UU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D4_MU_nearest_gaps_counts_pending, bins_dummy = np.histogram(D4_MU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D4_MM_nearest_gaps_counts_pending, bins_dummy = np.histogram(D4_MM_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D4_XX_nearest_gaps_counts_pending, bins_dummy = np.histogram(D4_XX_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        ...
        #D5_UU_nearest_gaps_counts_pending, bins_dummy = np.histogram(D5_UU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D5_MU_nearest_gaps_counts_pending, bins_dummy = np.histogram(D5_MU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D5_MM_nearest_gaps_counts_pending, bins_dummy = np.histogram(D5_MM_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #D5_XX_nearest_gaps_counts_pending, bins_dummy = np.histogram(D5_XX_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        ...
        #Sim_UU_nearest_gaps_counts_pending, bins_dummy = np.histogram(Sim_UU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #Sim_MU_nearest_gaps_counts_pending, bins_dummy = np.histogram(Sim_MU_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #Sim_MM_nearest_gaps_counts_pending, bins_dummy = np.histogram(Sim_MM_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        #Sim_XX_nearest_gaps_counts_pending, bins_dummy = np.histogram(Sim_XX_gaps_pending, bins = N_corrns_bins,range=(-0.5,N_corrns_bins-0.5))
        ...
        #D3_UU_gaps_counts = np.add(D3_UU_gaps_counts,D3_UU_gaps_counts_pending)
        #D3_MU_gaps_counts = np.add(D3_MU_gaps_counts,D3_MU_gaps_counts_pending)
        #D3_MM_gaps_counts = np.add(D3_MM_gaps_counts,D3_MM_gaps_counts_pending)
        #D3_XX_gaps_counts = np.add(D3_XX_gaps_counts,D3_XX_gaps_counts_pending)

        #D3_UU_nearest_gaps_counts = np.add(D3_UU_nearest_gaps_counts,D3_UU_nearest_gaps_counts_pending)
        #D3_MU_nearest_gaps_counts = np.add(D3_MU_nearest_gaps_counts,D3_MU_nearest_gaps_counts_pending)
        #D3_MM_nearest_gaps_counts = np.add(D3_MM_nearest_gaps_counts,D3_MM_nearest_gaps_counts_pending)
        #D3_XX_nearest_gaps_counts = np.add(D3_XX_nearest_gaps_counts,D3_XX_nearest_gaps_counts_pending)
        ...
        # D3_mu_methylation_fraction = np.mean(D3_locus_mean_M_level_pending)
        # D3_sigma_methylation_fraction = np.std(D3_locus_mean_M_level_pending)
        # D4_mu_methylation_fraction = np.mean(D4_locus_mean_M_level_pending)
        # D4_sigma_methylation_fraction = np.std(D4_locus_mean_M_level_pending)
        ...
        # D3D4D5_locus_mean_M_level_pending = np.hstack((D3_locus_mean_M_level_pending,
        #                                         D4_locus_mean_M_level_pending,
        #                                         D5_locus_mean_M_level_pending))
        # D3D4D5_mu_methylation_fraction = np.mean(D3D4D5_locus_mean_M_level_pending)
        # D3D4D5_sigma_methylation_fraction = np.std(D3D4D5_locus_mean_M_level_pending)
        ...
        # D3_number_0M_frac = np.count_nonzero(np.array(D3_locus_mean_M_level_pending) == 0.0)
        # D4_number_0M_frac = np.count_nonzero(np.array(D4_locus_mean_M_level_pending) == 0.0)
        # D5_number_0M_frac = np.count_nonzero(np.array(D5_locus_mean_M_level_pending) == 0.0)
        # D3D4D5_number_0M_frac = np.count_nonzero(np.array(D3D4D5_locus_mean_M_level_pending) == 0.0)

        # D3_mu_meth_diff = Sim10_mu_methylation_fraction - D3_mu_methylation_fraction
        # D4_mu_meth_diff = Sim10_mu_methylation_fraction - D4_mu_methylation_fraction
        # D5_mu_meth_diff = Sim10_mu_methylation_fraction - D5_mu_methylation_fraction
        # D3D4D5_mu_meth_diff = Sim_mu_methylation_fraction -  D3D4D5_mu_methylation_fraction

        LocusProperties_temp = [current_gene_ID, current_segment_no,current_seed, N_CG, L_locus, N_CG_density,
                                        #    Sim_mu_methylation_fraction, Sim_sigma_methylation_fraction, 
                                        #    Sim10_mu_methylation_fraction, Sim10_sigma_methylation_fraction,
                                        #    D3_mu_methylation_fraction, D3_sigma_methylation_fraction, 
                                        #    D4_mu_methylation_fraction, D4_sigma_methylation_fraction, 
                                        #     D5_mu_methylation_fraction, D5_sigma_methylation_fraction,
                                        #    D3D4D5_mu_methylation_fraction, D3D4D5_sigma_methylation_fraction,
                                        #     Sim_number_0M_frac, Sim10_number_0M_frac,
                                        #     D3_number_0M_frac, D4_number_0M_frac, 
                                        #     D5_number_0M_frac,
                                        #     D3D4D5_number_0M_frac,
                                           Col0_locus_mean_M_level_pending, 
                                            ...
                                            # D3_locus_mean_M_level_pending[0], D3_locus_mean_M_level_pending[1], D3_locus_mean_M_level_pending[2], 
                                            # D4_locus_mean_M_level_pending[0], D4_locus_mean_M_level_pending[1], D4_locus_mean_M_level_pending[2], 
                                            ...
                                            locus_gain_rate_mu_pending, np.sqrt(locus_gain_rate_sigmaSQ_pending),
                                            locus_loss_rate_mu_pending, np.sqrt(locus_loss_rate_sigmaSQ_pending)
                                           ]
        ...
        #                          D3_locus_mean_M_level_pending[0], D3_locus_mean_M_level_pending[1], D3_locus_mean_M_level_pending[2],
        #                          D3_locus_mean_M_level_pending[3], D3_locus_mean_M_level_pending[4], D3_locus_mean_M_level_pending[5],
        #                          D3_locus_mean_M_level_pending[6], D3_locus_mean_M_level_pending[7], D3_locus_mean_M_level_pending[8],
        #                          D3_locus_mean_M_level_pending[9], 
        #                          D4_locus_mean_M_level_pending[0], D4_locus_mean_M_level_pending[1], D4_locus_mean_M_level_pending[2],
        #                          D4_locus_mean_M_level_pending[3], D4_locus_mean_M_level_pending[4], D4_locus_mean_M_level_pending[5],
        #                          D4_locus_mean_M_level_pending[6], D4_locus_mean_M_level_pending[7], D4_locus_mean_M_level_pending[8],
        #                          D4_locus_mean_M_level_pending[9], 
        #                          D5_locus_mean_M_level_pending[0], D5_locus_mean_M_level_pending[1], D5_locus_mean_M_level_pending[2],
        #                          D5_locus_mean_M_level_pending[3], D5_locus_mean_M_level_pending[4], D5_locus_mean_M_level_pending[5],
        #                          D5_locus_mean_M_level_pending[6], D5_locus_mean_M_level_pending[7], D5_locus_mean_M_level_pending[8],
        #                          D5_locus_mean_M_level_pending[9]]
...
#temp_output_list = D3_MM_gaps_counts
#temp_output_file = file_name_output_PairSeparationsMM_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_MU_gaps_counts
#temp_output_file = file_name_output_PairSeparationsMU_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_UU_gaps_counts
#temp_output_file = file_name_output_PairSeparationsUU_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_XX_gaps_counts
#temp_output_file = file_name_output_PairSeparationsXX_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_MM_nearest_gaps_counts
#temp_output_file = file_name_output_NearestPairSeparationsMM_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_MU_nearest_gaps_counts
#temp_output_file = file_name_output_NearestPairSeparationsMU_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_UU_nearest_gaps_counts
#temp_output_file = file_name_output_NearestPairSeparationsUU_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)

#temp_output_list = D3_XX_nearest_gaps_counts
#temp_output_file = file_name_output_NearestPairSeparationsXX_D3
#with open(temp_output_file,'a',newline='') as output_file:
#    line_writer = csv.writer(output_file,delimiter='\t')
#    line_writer.writerow(temp_output_list)
...
temp_output_list = Sim_gains_nn_dist_M_counts
temp_output_file = file_name_output_SimGains_nn_dist_M
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_gains_nn_dist_U_counts
temp_output_file = file_name_output_SimGains_nn_dist_U
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_losses_nn_dist_M_counts
temp_output_file = file_name_output_SimLosses_nn_dist_M
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_losses_nn_dist_U_counts
temp_output_file = file_name_output_SimLosses_nn_dist_U
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_StayM_nn_dist_M_counts
temp_output_file = file_name_output_SimStayM_nn_dist_M
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_StayM_nn_dist_U_counts
temp_output_file = file_name_output_SimStayM_nn_dist_U
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_StayU_nn_dist_M_counts
temp_output_file = file_name_output_SimStayU_nn_dist_M
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)

temp_output_list = Sim_StayU_nn_dist_U_counts
temp_output_file = file_name_output_SimStayU_nn_dist_U
with open(temp_output_file,'a',newline='') as output_file:
    line_writer = csv.writer(output_file,delimiter='\t')
    line_writer.writerow(temp_output_list)
