...
ax.set_ylabel("Mean time to reach\nsteady-state "+TimeScaleFactorLabel, fontsize=10)

Sims_mutant_label =  '$\it{%s}$ Sim.' % mutant_label[:-6]

ax.set_title("%s\n$r^*$ = %.2f,  $\epsilon$ = %.1f$\\times10^{-4}$\nMean over all loci: %.2f" % (Sims_mutant_label,coop_strength, e_c_val,np.mean(LocusProperties_Sim_df['Sim_Mfrac_FirstTimeSteadyState_AccnMu'].values*TimeScaleFactor/n_cc)),fontsize=10)

fig.tight_layout()
#fig.subplots_adjust(top=0.5)

fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mean_FirstSteadyStateTime_scatter.png"), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mean_FirstSteadyStateTime_scatter.pdf"), bbox_inches = 'tight')
...
ax.yaxis.set_tick_params(labelsize=10)
ax.set_xlabel("Locus length (CG sites)", fontsize=10)
ax.set_ylabel("s.d. of time to reach\nsteady-state "+TimeScaleFactorLabel, fontsize=10)

ax.set_title("%s\n$r^*$ = %.2f,  $\epsilon$ = %.1f$\\times10^{-4}$\nMean over all loci: %.1f" % (Sims_mutant_label,coop_strength, e_c_val,np.mean(LocusProperties_Sim_df['Sim_Mfrac_FirstTimeSteadyState_AccnSigma'].values*TimeScaleFactor/n_cc)),fontsize=10)

fig.tight_layout()
#fig.subplots_adjust(top=0.5)

fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Std_FirstSteadyStateTime_scatter.png"), bbox_inches = 'tight')
fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Std_FirstSteadyStateTime_scatter.pdf"), bbox_inches = 'tight')
...
# ax.yaxis.set_tick_params(labelsize=10)
# ax.set_xlabel("Locus length (CG sites)", fontsize=10)
# ax.set_ylabel("s.d. of fluctuation\nmagnitudes (meth. %)", fontsize=10)
...
# fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mfrac_star_TimeSigma_scatter_F5C.png"), bbox_inches = 'tight')
...
# ax.yaxis.set_tick_params(labelsize=10)
# ax.set_xlabel("Locus length (CG sites)", fontsize=10)
# ax.set_ylabel("Greatest fluctuation\nmagnitude (meth. %)", fontsize=10)

# ax.set_title("Mean over all loci: %.2f" % np.mean(LocusProperties_Sim_df['Sim_Mfrac_MaxFluct_Magnitude_AccnMu'].values),fontsize=10)


# fig.tight_layout()
# #fig.subplots_adjust(top=0.5)

# fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mean_MaxFluct_Magnitude_scatter_F5A.png"), bbox_inches = 'tight')
...
# from mpl_toolkits.axes_grid1.inset_locator import inset_axes
# axins_1 = inset_axes(ax, width="60%", height="50%", borderpad=0.6)
...
# ax.yaxis.set_tick_params(labelsize=10)
# ax.set_xlabel("Locus length (CG sites)", fontsize=10)
# ax.set_ylabel("s.d. of greatest fluctuation\nmagnitudes (meth. %)", fontsize=10)

# ax.set_title("Mean over all loci: %.2f" % np.mean(LocusProperties_Sim_df['Sim_Mfrac_MaxFluct_Magnitude_AccnSigma'].values),fontsize=10)


# fig.tight_layout()
# #fig.subplots_adjust(top=0.5)

# fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Std_MaxFluct_Magnitude_scatter_SF10A.png"), bbox_inches = 'tight')
...
# ax.yaxis.set_tick_params(labelsize=10)
# ax.set_xlabel("Locus length (CG sites)", fontsize=10)
# ax.set_ylabel('Greatest fluctuation\ndurration '+TimeScaleFactorLabel, fontsize=10)

# ax.set_title("Mean over all loci: %.2f" % np.mean(LocusProperties_Sim_df['Sim_Mfrac_MaxFluct_Duration_AccnMu'].values*TimeScaleFactor/n_cc),fontsize=10)


# fig.tight_layout()
# #fig.subplots_adjust(top=0.5)

# fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mean_MaxFluct_Duration_scatter_F5B.png"), bbox_inches = 'tight')
...
# ax.set_title("Mean over all loci: %.2f" % np.mean(LocusProperties_Sim_df['Sim_Mfrac_MaxFluct_Duration_AccnSigma'].values*TimeScaleFactor/n_cc),fontsize=10)


# fig.tight_layout()
# #fig.subplots_adjust(top=0.5)

# fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Std_MaxFluct_Duration_scatter_SF10B.png"), bbox_inches = 'tight')
...
# ax.plot(N_CG_vals, FirstMTimes_vals/n_cc,  linewidth = 1, color='r')

# ax.xaxis.set_tick_params(labelsize=10)
# ax.yaxis.set_tick_params(labelsize=10)
# ax.set_xlabel("Locus length (CG sites)", fontsize=10)
# ax.set_ylabel("Mean time to first $M$ gain (gens.)", fontsize=10)

# ax.set_title("Mean over all loci: %.0f" % np.mean(LocusProperties_Sim_df['Sim_FirstTimeChangedSite_AccnMu'].values/n_cc),fontsize=10)

# fig.tight_layout()
# #fig.subplots_adjust(top=0.5)

# fig.savefig( os.path.join(GraphFolder,filename_start_Graph +"Mean_FirstTimeChangedSite_scatter_SF8B.png"), bbox_inches = 'tight')
