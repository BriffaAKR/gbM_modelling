...
print(len(LocusProperties_df))

# Manually load in the Sims from all-U initial state. 
file_in_AllRepsMethFracs_Expt = os.path.join('Output_files', 
'UM_Genes_EqbrmOutput_WgRatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_AllRepsMethFracs.tsv')
...
print('N_gene_Sim',len(AllRepsMethFracs_Expt_df))

filename_start_Graph = "UM_Genes_EqbrmOutput_WgRatesOnlyFit_Pchoice_Excl_InitialState_100U_Ngen_1E5_Graph_"
