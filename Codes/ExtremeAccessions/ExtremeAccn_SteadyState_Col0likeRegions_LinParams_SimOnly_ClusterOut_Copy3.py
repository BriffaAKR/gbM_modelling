...
import input_params_Copy3 as params # import my params from separate python file
...
def single_gene_sim_eqbrm_single_time_stats(N_CG_, state_in_, CG_positions_,
    ...
    while time_ < burn_in_time:
        ...
        # print(current_gene_ID,state_)
        # print('len',len(state_))
        # print('propensities', total_propensities_vector_)
        # print('cum prop', cumulative_propensities_)
        propensities_cut_off_ = random_pair_[1]*cumulative_propensities_[-1]
        # print('prop cut', propensities_cut_off_)
        # print('ordered site list',ordered_site_list_)
        # print('len ordered site list',len(ordered_site_list_))
        # print('ordered site list index', np.searchsorted(cumulative_propensities_, propensities_cut_off_))
        change_index_ = ordered_site_list_[ np.searchsorted(cumulative_propensities_, propensities_cut_off_) ]
        # print('change index',change_index_)
        # print()
