...
ParamCode_list_Can0UKID116Cvi0_Both = ['Sim_Coop0p85_delta4p0_','Sim_Coop0p92_delta1p0_']
Labels_Can0UKID116Cvi0_Both = ['$r^*$ = 0.85\n$r_0^+$ = 4.0','$r^*$ = 0.92\n$r_0^+$ = 1.0']
colors_list_Can0UKID116Cvi0_Both = ['m', 'b']
...
Labels_NS_Both = ['$r^*$ = 1.1\n$r_0^+$ = 4.0','$r^*$ = 1.0\n$r_0^+$ = 12.5']
colors_list_NS_Both = ['green', 'darkorange', ]
...
Labels_RL_Both = ['$r^*$ = 0.98\n$r_0^+$ = 4.0','$r^*$ = 1.00\n$r_0^+$ = 2.5']
colors_list_RL_Both = ['green', 'brown']
...
#                   label='N_bins = %d\nSim. $\mu$ = %.1f' % (n_bin,np.nanmean(AllRepsMethFracs_df[temp_cols_list].values)))
# ax[1].plot(x_hist, hist_Sim,  linewidth = 2, color='r',
#                   label='Normalised\nSim. $\mu$ = %.1f' % np.nanmean(AllRepsMethFracs_df[temp_cols_list].values))
...
ax.plot(x_hist, hist_Col0,  linewidth = linewidth_1, color=colors_list_sweep[4],
                  label='Col0: Mean = %.1f %%' % np.nanmean(LocusProperties_Col0_df[['Col0_meth_frac']].values*values_scaler))
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_AllData_F6A.png"), bbox_inches = 'tight')
...
ax.plot(x_hist, hist_Cvi0,  linewidth = linewidth_1, color=colors_list_sweep[0],
                  label='Cvi0: Mean = %.1f %%' % np.nanmean(LocusProperties_Cvi0_df[['Col0_X_frac']].values*values_scaler))
...
ax.plot(x_hist, hist_UKID116,  linewidth = linewidth_1, color=colors_list_sweep[1],
                  label='UKID116: Mean = %.1f %%' % np.nanmean(LocusProperties_UKID116_df[['Col0_X_frac']].values*values_scaler))
...
ax.plot(x_hist, hist_Can0,  linewidth = linewidth_1, color=colors_list_sweep[2],
                  label='Can0: Mean = %.1f %%' % np.nanmean(LocusProperties_Can0_df[['Col0_X_frac']].values*values_scaler))
...
ax.plot(x_hist, hist_RLFilt,  linewidth = linewidth_1, color=colors_list_sweep[3],
                  label='RL: Mean = %.1f %%' % np.nanmean(AllRepsXFracs_RLFilt_df[temp_cols_list].values*values_scaler))
...
ax.plot(x_hist, hist_Col0,  linewidth = linewidth_1, color=colors_list_sweep[4],
                  label='Col0: Mean = %.1f %%' % np.nanmean(LocusProperties_Col0_df[['Col0_X_frac']].values*values_scaler))
...
ax.plot(x_hist, hist_NSFilt,  linewidth = linewidth_1, color=colors_list_sweep[5],
                  label='NS: Mean = %.1f %%' % np.nanmean(AllRepsXFracs_NSFilt_df[temp_cols_list].values*values_scaler))
...
ax.plot(x_hist, hist_Dor10,  linewidth = linewidth_1, color=colors_list_sweep[6],
                  label='Dor10: Mean = %.1f %%' % np.nanmean(LocusProperties_Dor10_df[['Col0_X_frac']].values*values_scaler))
...
for i_ in range(len(AllRepsMethFracs_CoopStrengthSweep_df_list)):
    ...
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_1, color=colors_list_sweep[i_],
                    label='%s: Mean = %.1f %%' % (Labels_CoopStrengthSweep[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_CoopStrengthSweep_F6B.png"), bbox_inches = 'tight')
...
for i_ in range(len(AllRepsMethFracs_DeltaSweep_df_list)):
    ...
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_sweep[i_],linewidth = linewidth_1)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_1, color=colors_list_sweep[i_],
                    label='%s: Mean = %.1f %%' % (Labels_DeltaSweep[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_DeltaSweep_F6C.png"), bbox_inches = 'tight')
...
# Col0
hist_Col0, bins_Col0 = np.histogram(LocusProperties_Col0_df[['Col0_meth_frac']].values*values_scaler, bins=n_bin, range=(x_start,x_end))
# ax.axvline(np.nanmean(LocusProperties_Col0_df[['Col0_X_frac']].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_Col0,  linewidth = linewidth_2, color='k',
                  label='Col0: Mean = %.1f %%' % np.nanmean(LocusProperties_Col0_df[['Col0_meth_frac']].values*values_scaler))
...
for i_ in range(len(AllRepsMethFracs_Col0Fit_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color='green',linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color='green',
                    label='%s: Mean = %.1f %%' % (Labels_Col0Fit[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
# Cvi0
hist_Cvi0, bins_Cvi0 = np.histogram(LocusProperties_Cvi0_df[['Col0_meth_frac']].values*values_scaler, bins=n_bin, range=(x_start,x_end))
# ax.axvline(np.nanmean(LocusProperties_Cvi0_df[['Col0_meth_frac']].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_Cvi0,  linewidth = linewidth_2, color='k', linestyle='-',
                  label='Cvi0: Mean = %.1f %%' % np.nanmean(LocusProperties_Cvi0_df[['Col0_meth_frac']].values*values_scaler))


# UKID116
hist_UKID116, bins_UKID116 = np.histogram(LocusProperties_UKID116_df[['Col0_meth_frac']].values*values_scaler, bins=n_bin, range=(x_start,x_end))
# ax.axvline(np.nanmean(LocusProperties_UKID116_df[['Col0_meth_frac']].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_UKID116,  linewidth = linewidth_2, color='k', linestyle='--',
                  label='UKID116: Mean = %.1f %%' % np.nanmean(LocusProperties_UKID116_df[['Col0_meth_frac']].values*values_scaler))


# Can0
hist_Can0, bins_Can0 = np.histogram(LocusProperties_Can0_df[['Col0_meth_frac']].values*values_scaler, bins=n_bin, range=(x_start,x_end))
# ax.axvline(np.nanmean(LocusProperties_Can0_df[['Col0_meth_frac']].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_Can0,  linewidth = linewidth_2, color='k', linestyle=':',
                  label='Can0: Mean = %.1f %%' % np.nanmean(LocusProperties_Can0_df[['Col0_meth_frac']].values*values_scaler))
...
for i_ in range(len(AllRepsMethFracs_Can0UKID116Cvi0_CoopStrength_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_Can0UKID116Cvi0_CoopStrength[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_Can0UKID116Cvi0_CoopStrength[i_],
...
for i_ in range(len(AllRepsMethFracs_Can0UKID116Cvi0_Delta_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_Can0UKID116Cvi0_Delta[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_Can0UKID116Cvi0_Delta[i_],
...
for i_ in range(len(AllRepsMethFracs_Can0UKID116Cvi0_Both_df_list)):
    ...
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_Can0UKID116Cvi0_Delta[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_Can0UKID116Cvi0_Delta[i_],
                    label='%s: Mean = %.1f %%' % (Labels_Can0UKID116Cvi0_Both[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_Can0UKID116Cvi0_Both_FS11D.png"), bbox_inches = 'tight')
...
# Dor10
hist_Dor10, bins_Dor10 = np.histogram(LocusProperties_Dor10_df[['Col0_meth_frac']].values*values_scaler, bins=n_bin, range=(x_start,x_end))
# ax.axvline(np.nanmean(LocusProperties_Dor10_df[['Col0_meth_frac']].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_Dor10,  linewidth = linewidth_2, color='k',
                  label='Dor10: Mean = %.1f %%' % np.nanmean(LocusProperties_Dor10_df[['Col0_meth_frac']].values*values_scaler))
...
for i_ in range(len(AllRepsMethFracs_Dor10_CoopStrength_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_Dor10_CoopStrength[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_Dor10_CoopStrength[i_],
...
for i_ in range(len(AllRepsMethFracs_Dor10_Delta_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_Dor10_Delta[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_Dor10_Delta[i_],
...
for i_ in range(len(AllRepsMethFracs_Dor10_Both_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_Dor10_Both[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_Dor10_Both[i_],
                    label='%s: Mean = %.1f %%' % (Labels_Dor10_Both[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_Dor10_Both_FS11A.png"), bbox_inches = 'tight')
...
hist_NSFilt, bins_NSFilt = np.histogram(AllRepsMethFracs_NSFilt_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
hist_NSFilt = hist_NSFilt/N_ExptState_NSFilt # normalise
# ax.axvline(np.nanmean(AllRepsMethFracs_NSFilt_df[temp_cols_list].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_NSFilt,  linewidth = linewidth_2, color='k',
                  label='NS: Mean = %.1f %%' % np.nanmean(AllRepsMethFracs_NSFilt_df[temp_cols_list].values*values_scaler))
...
for i_ in range(len(AllRepsMethFracs_NS_CoopStrength_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_NS_CoopStrength[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_NS_CoopStrength[i_],
...
for i_ in range(len(AllRepsMethFracs_NS_Delta_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_NS_Delta[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_NS_Delta[i_],
...
for i_ in range(len(AllRepsMethFracs_NS_Both_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_NS_Both[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_NS_Both[i_],
                    label='%s: Mean = %.1f %%' % (Labels_NS_Both[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_NS_Both_FS11B.png"), bbox_inches = 'tight')
...
hist_RLFilt, bins_RLFilt = np.histogram(AllRepsMethFracs_RLFilt_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
hist_RLFilt = hist_RLFilt/N_ExptState_RLFilt # normalise
# ax.axvline(np.nanmean(AllRepsMethFracs_RLFilt_df[temp_cols_list].values*values_scaler), linestyle='--', color='k',  linewidth = linewidth_2)
ax.plot(x_hist, hist_RLFilt,  linewidth = linewidth_2, color='k',
                  label='RL: Mean = %.1f %%' % np.nanmean(AllRepsMethFracs_RLFilt_df[temp_cols_list].values*values_scaler))
...
for i_ in range(len(AllRepsMethFracs_RL_CoopStrength_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_RL_CoopStrength[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_RL_CoopStrength[i_],
...
for i_ in range(len(AllRepsMethFracs_RL_Delta_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_RL_Delta[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_RL_Delta[i_],
...
for i_ in range(len(AllRepsMethFracs_RL_Both_df_list)):
    ...
    hist_temp, bins_temp = np.histogram(temp_df[temp_cols_list].values*values_scaler, bins=n_bin, range=(x_start,x_end))
    hist_temp = hist_temp/N_reps # normalise
    # ax.axvline(np.nanmean(temp_df[temp_cols_list].values*values_scaler), linestyle='--', color=colors_list_RL_Both[i_],linewidth = linewidth_2)
    ax.plot(x_hist, hist_temp,  linewidth = linewidth_2, color=colors_list_RL_Both[i_],
                    label='%s: Mean = %.1f %%' % (Labels_RL_Both[i_],np.nanmean(temp_df[temp_cols_list].values*values_scaler)) )
...
fig.savefig( os.path.join(GraphFolder,filename_start +"ExtemeAccns_RL_Both_FS11C.png"), bbox_inches = 'tight')
