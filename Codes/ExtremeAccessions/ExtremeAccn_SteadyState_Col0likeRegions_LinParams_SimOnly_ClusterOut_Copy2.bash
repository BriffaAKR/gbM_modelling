...
python3 -u ExtremeAccn_SteadyState_Col0likeRegions_LinParams_SimOnly_ClusterOut_Copy2.py ${SLURM_ARRAY_TASK_ID} 250 # check last integer compatible with array endRRAY_TASK_ID} 250 # check last integer compatible with array end