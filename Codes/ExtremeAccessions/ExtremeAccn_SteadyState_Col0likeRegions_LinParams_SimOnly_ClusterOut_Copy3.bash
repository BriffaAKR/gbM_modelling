...
# #SBATCH --array=81 # end of array (N).  2nd argument of python code should be: N . start of array must by 0

# plan to make output_file_0 to contain just headers, and then have N output files

source anaconda3-5.2.0

python3 -u ExtremeAccn_SteadyState_Col0likeRegions_LinParams_SimOnly_ClusterOut_Copy3.py ${SLURM_ARRAY_TASK_ID} 250 # check last integer compatible with array endRRAY_TASK_ID} 250 # check last integer compatible with array end
