...
python3 -u ExtremeAccn_SteadyState_Col0likeRegions_LinParams_DatOnly_ClusterOut.py ${SLURM_ARRAY_TASK_ID} 250 # check last integer compatible with array end